...
// APIClient manages communication with the Mercedes-Benz AG Programming Challenge API v1.0.0
...
type APIClient struct {
	...
	VehicleTripAnalyzerApi *VehicleTripAnalyzerApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.VehicleTripAnalyzerApi = (*VehicleTripAnalyzerApiService)(&c.common)
